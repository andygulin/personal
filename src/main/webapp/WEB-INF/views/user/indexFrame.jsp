...
$(document).ready(function() {
	$.get("${ctx}/user/ajaxArticle",{},function(data){$("#rowArticle").html(data);});
	$.get("${ctx}/user/ajaxAccout",{},function(data){$("#rowAccout").html(data);});
	$.get("${ctx}/user/ajaxPhoto",{},function(data){$("#rowPhoto").html(data);});
	$.get("${ctx}/user/ajaxContacts",{},function(data){$("#rowContacts").html(data);});
});
</script>
