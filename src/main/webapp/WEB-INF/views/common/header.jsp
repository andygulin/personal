...
<head>
    ...
    <link href="${ctx}/static/bootstrap-fileupload/bootstrap-fileupload.min.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="${ctx}/static/bootstrap-fileupload/bootstrap-fileupload.min.js" type="text/javascript"></script>
    <script src="//cdn.bootcss.com/magnific-popup.js/1.0.1/jquery.magnific-popup.min.js"></script>
    <title>${title }</title>
</head>
<body>