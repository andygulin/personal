...
<%@ include file="/WEB-INF/views/common/menu.jsp" %>
	...
	<form id="contactsForm" action="${ctx}/contacts/${action}" method="post" class="form-horizontal">
		...
		<fieldset>
			<legend><small>联系人管理</small></legend>
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<c:forEach var="at" items="${contactsType }">
        				<option <c:if test="${(not empty contacts.type.id) and (contacts.type.id eq at.id)}">selected="selected"</c:if> value="${at.id }">${at.name }</option>
        			</c:forEach>
    				</select>
				</div>
			</div>		
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="mobile" name="mobile"  value="${contacts.mobile}" class="input-large required" />
				</div>
			</div>	
			<div class="control-group">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="address" name="address"  value="${contacts.address}" class="input-large required" style="width:500px;" />
				</div>
			</div>	
			<div class="control-group">
				<label for="contacts_remark" class="control-label">备注:</label>
				<div class="controls">
					<input type="text" id="remark" name="remark"  value="${contacts.remark}" class="input-large required" style="width:500px;" />
				</div>
			</div>	
